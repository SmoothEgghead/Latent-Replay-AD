...
buffer = ReplayBuffer()
buffer.load_latents("buffer.pt")
snapshot = freeze_decoder_snapshot(model.decoder)

training_config['model'] = model
training_config['training_data'] = train_data
training_config['testing_data'] = test_data
training_config['snapshot'] = snapshot
training_config['buffer'] = buffer

"""
Training and Testing
"""
trainer = LatentTrainer(**training_config)
